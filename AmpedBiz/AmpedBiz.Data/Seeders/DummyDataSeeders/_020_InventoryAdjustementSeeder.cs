...
{
	public class _020_InventoryAdjustementSeeder : IDummyDataSeeder
    {
        private readonly IContextProvider _contextProvider;
        private readonly ISessionFactory _sessionFactory;

        public _020_InventoryAdjustementSeeder(IContextProvider contextProvider, ISessionFactory sessionFactory)
        {
