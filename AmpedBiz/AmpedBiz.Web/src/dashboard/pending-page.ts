export class PendingList {
  ...
  constructor() {
    ...
    this.activeOrders = [
      ...
      { id: 0, orderDate: "12/10/2015", status: "Shipped", salesPerson: "Steven Thorpe", customerName: "Helena Kupkova", company: "Company L", subTotal: "₱586.25", orderTotal: "₱665.56" },
      ...
      { id: 0, orderDate: "12/26/2015", status: "Shipped", salesPerson: "Jan Kotas", customerName: "Anna Bedecs", company: "Company Z", subTotal: "₱1,468.75", orderTotal: "₱1,542.18" },
    ];
