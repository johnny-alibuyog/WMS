...
{
    public class GetEmployeeTypePage
    {
        public class Request : PageRequest, IRequest<Response> { }

        public class Response : PageResponse<Dto.EmployeeTypePageItem> { }
        ...
        public class Handler : IRequestHandler<Request, Response>
        {
            ...
            public Response Handle(Request message)
            {
                ...
                {
                    var query = session.Query<Entity.EmployeeType>();
                    ...
                    var itemsFuture = query
                        .Select(x => new Dto.EmployeeTypePageItem()
                        {
                            Id = x.Id,
                            Name = x.Name
                        })
