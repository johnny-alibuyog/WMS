...
{
	public class GetProductInventoryUnitOfMeasure
	{
		...
		public class Response : Dto.ProductInventoryUnitOfMeasure { }
				...
				using (var transaction = session.BeginTransaction())
				{
					...
					response = new Response()
					{
						...
						Prices = entity.Prices
							.Select(x => new Dto.ProductInventoryUnitOfMeasurePrice()
							{
								Id = x.Id,
